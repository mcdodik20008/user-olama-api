...
@Component
class AvailableModels (var commander: Commander, var olamaWebClient: OlamaWebClient, var textEditor: TextEditor) : BotCommand(CommandName.AVAILABLE_MODELS.text, "Описание команды") {
